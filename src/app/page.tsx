  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 space-y-8">
        {/* Hero Section */}
        {!walletAddress && (
          <section className="text-center py-8 md:py-16 space-y-4 md:space-y-6 px-4">
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center items-center gap-4 md:gap-6 pt-4">
              <div className="glass p-3 md:p-4 flex items-center gap-3 w-full sm:w-auto max-w-xs">
                <Globe className="w-6 h-6 md:w-8 md:h-8 text-stellar-400 flex-shrink-0" />
                <div className="text-left">
                  <p className="font-semibold text-xs md:text-sm">Multi-Wallet</p>
              ...
              <div className="glass p-3 md:p-4 flex items-center gap-3 w-full sm:w-auto max-w-xs">
                <Shield className="w-6 h-6 md:w-8 md:h-8 text-green-400 flex-shrink-0" />
                <div className="text-left">
                  <p className="font-semibold text-xs md:text-sm">Smart Contract</p>
                  <p className="text-xs text-gray-400">
                    Soroban on Testnet
                  </p>
                </div>
              ...
              <div className="glass p-3 md:p-4 flex items-center gap-3 w-full sm:w-auto max-w-xs">
                ...
                <div className="text-left">
                  <p className="font-semibold text-xs md:text-sm">Real-time</p>
                  <p className="text-xs text-gray-400">
                    Live event tracking
                  </p>
                </div>
